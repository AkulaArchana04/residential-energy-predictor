...
<style>
.stApp {
    background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXtKpj1_uAwLUdnDYgf2GtTWnW2ptF7TGHIg&");
...
# Model selection
model_option = st.selectbox("🧠 Choose Model", ["Random Forest", "Linear Regression"])
model_path = "Random_forest_model.pkl" if model_option == "Random Forest" else "Linear_model.pkl"
...
if submitted:
    ...
    try:
        ...
        st.success(f"🔋 Estimated Energy Usage using *{model_option}: **{prediction:.2f} kWh*")
